				...
				<table class="table-view table table-striped">
					<thead>
						<tr class="list-general table-primary">
							...
							<th>Action</th>
							<?php } ?>
							<?php if($ModuleName=="manpower" || $ModuleName=="ehs" || $ModuleName=="water_management" || $ModuleName=="revenue_data"  || $ModuleName=="log_user_details"  || $ModuleName=="production" || $ModuleName=="users"  || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"){
							}else{?>
								<th>Status</th>
							<?php }?>
						...
						<?php } else { ?>
							...
							<tr>
								...
								<?php if($ModuleName!="log_user_details"){?>
									...
									<td>
										<div class="d-flex justify-content-evenly">
											...
											if($valuecheck=='3'){ ?>  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><?php } 
												...
												<?php } else if ($user_id=='1' ||$user_id=='222' ||$user_id=='217'||$user_id=='208') { ?> 
													<a href="<?php echo $ActionUrl;?>Edit/Record/<?php echo $Record['RecordId']; ?>">
														<div class="action-icon-container d-flex justify-content-center align-items-center">
															<div class="action-icon-container-label">
																<span>Edit</span>
									...
									<?php } ?>
								<?php if($ModuleName=="manpower" || $ModuleName=="production" || $ModuleName=="users" || $ModuleName=="log_user_details" || $ModuleName=="revenue_data"  || $ModuleName=="ehs" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"  || $ModuleName=="water_management"  ){
								}else { ?>
