...
<nav aria-label="breadcrumb" class="mt-2">
    <ol class="breadcrumb rounded-3">
        ...
        <li class="breadcrumb-item">
            <a class="link-body-emphasis text-decoration-none gray-shade-2-breadcrum">Degaussing</a>
        </li>
    </ol>
</nav>
 <h4>Overview</h4>
    <div class="overview">
        ...
        <div class="overview-card completed-card">
            <p>Completed</p>
            <div class="d-flex align-items-baseline">
                <p class="dashboard-figure"><?php echo $completed_count??"0";?></p>
                <div class="custom-green-text">
                    <span class="ms-2">+ 0.00%</span> <i class="fa-solid fa-arrow-up"></i>
                </div>
            </div>
        ...
        <div class="overview-card pending-card">
            <p>In Progress</p>
            <div class="d-flex align-items-baseline">
                <p class="dashboard-figure"><?php echo $in_process_count??"0";?></p>
                <div class="custom-green-text">
                    <span class="ms-2">+ 0.00%</span> <i class="fa-solid fa-arrow-up"></i>
                </div>
            </div>
        ...
        <table class="table table-hover custom-table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $pdata["hdd_count"]??"";?></td>
                    <td><?php echo $pdata["hdd_completed"]??"";?></td>
                    <td><?php echo $pdata["hdd_pending"]??"";?></td>
                    <td data-module="degaussing" <?php if($pdata["status"] == 5){?> data-request-id="<?php echo $pdata["degaussinginfo_id"]??"";?>" data-bs-toggle="modal" data-bs-target="#degaussingModal" <?php }?>><span class="<?php echo $status_class;?>"><?php echo $pdata["status_name"]??"";?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
...
<div class="modal fade" id="degaussingModal" tabindex="-1" aria-labelledby="degaussingLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="degaussingLabel">Degaussing</h1>
