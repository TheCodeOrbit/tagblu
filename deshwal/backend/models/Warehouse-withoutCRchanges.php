...
class Warehouse extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['warehouse_name', 'address', 'city', 'state', 'stateid', 'email', 'secondary_email', 'email_opt_out', 'exchange_rate', 'currency', 'branch', 'branch_id', 'attention', 'street1', 'street2', 'Country/Region', 'phone', 'warehouse_manager', 'contact_number', 'pan_number'], 'default', 'value' => null],
            [['deleted'], 'default', 'value' => 0],
            [['ownerid', 'creatorid', 'modifiedby', 'createdtime', 'modifiedtime', 'warehouse_no', 'statecode', 'pincode', 'gstn'], 'required'],
            [['ownerid', 'creatorid', 'modifiedby', 'city', 'stateid', 'exchange_rate', 'currency', 'branch_id', 'Country/Region', 'phone', 'contact_number', 'deleted'], 'integer'],
            [['createdtime', 'modifiedtime'], 'safe'],
            [['warehouse_name', 'branch', 'attention', 'street1', 'street2'], 'string', 'max' => 100],
