 ...
 * @property float|null $product_length
 * @property float|null $product_width
 * @property float|null $product_height
 */
class ProductDit extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['productdit_no', 'product_name', 'product_description', 'hsn_code', 'oem_part_number', 'unit_in_hand', 'opening_stock', 'master_category', 'product_nuture', 'groupid', 'category', 'sub_category', 'oem', 'cost_price', 'gst_percentage', 'seq_no', 'product_dimensions_cm', 'product_weight_kgs', 'uom', 'product_length', 'product_width', 'product_height'], 'default', 'value' => null],
            ...
            [['opening_stock', 'cost_price', 'gst_percentage', 'product_dimensions_cm', 'product_weight_kgs', 'product_length', 'product_width', 'product_height'], 'number'],
