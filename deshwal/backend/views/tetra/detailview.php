...
// $this->registerCssFile('https://cdn.quilljs.com/1.3.6/quill.snow.css', ['depends' => [AdminAsset::class]]);
                  ...
                  <div class="flex-row-e ovx">
                    <ul class="btn-pipeline">
                      ...
                      ?>
                        ...
                        <li
                          class="<?= $finclass; ?>  stage text-capitalize leaddurationparent <?= $value[$pipelinestatusvalue]; ?>"
                          data-id="<?= $value[$pipelinestatusid]; ?>" data-bt="<?= $bt; ?>" data-cl="<?= $finclass; ?>">
                        ...
                        <details class="c-faqs__item">
                          ...
                          <div class="row">
                            ...
                            if ($TabId == 18 && $Block->blockid == 149) {
                              ...
                              $sql = "select * from role where showinaccounts=1 and parentrole like '%H2::%'";
                              ...
                              ?>
                                <div
                                  class="detail-group Details-1  detail-<?= $value['rolename'] ?> <?= $clsssdet; ?>">
                                  <label
                                    title="<?= $value['rolename'] ?>"><?= $value['rolename'] ?></label>
                                  <span><?= $roleid; ?></span>
                                </div>
                              <?php
                              }
