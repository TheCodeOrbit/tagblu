						...
						<tbody id="pop_tbody">
							<tr id="pop_rows" >
								...
								<tr>
									...
									if($_REQUEST['promod1'] == 'promod') { ?> showParentProduct('<?php echo $pno; ?>','<?php echo $Record['productname'];?>','<?php echo $Record['RecordId'];?>','<?php echo $_REQUEST['key']; ?>'); <?php } if($_REQUEST['promod1'] == 'addinvoice') { ?> showParentrelatedmod('<?php echo $_REQUEST['pno']; ?>','<?php echo $Record['invoiceno'];?>','<?php echo $Record['RecordId'];?>','<?php echo $_REQUEST['key']; ?>','<?php echo $invdate1; ?>','<?php echo $invdate2; ?>','<?php echo $Record['outstanding_amt']; ?>');<?php } if($_REQUEST['promod1'] == 'addsubacc') { ?> showParentaddsubacc('<?php echo $_REQUEST['pno']; ?>','<?php echo $Record['sac_nm'];?>','<?php echo $Record['RecordId'];?>','<?php echo $_REQUEST['key']; ?>');<?php } }?>" data-dismiss="modal"><?php echo $Record[$key];?>
