...
<div id="ListDrill" class="show">
	<div class="body-menu d-flex justify-content-between">
		...
		<?php if(in_array('5',$val) or $operation['opt'] =='1') {
			if($ModuleName=="water_management" || $ModuleName=="ehs" || $ModuleName=="manpower" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material" || $ModuleName=="revenue_data"){}
			else{ ?>
