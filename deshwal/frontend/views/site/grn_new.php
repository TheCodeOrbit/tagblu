    ...
    <div class="overview">
        ...
        <div class="overview-card processed-card">
            ...
            <div class="d-flex align-items-baseline">
                <p class="dashboard-figure">
                    <?php 
                        if(isset($total_assets_processed)){
                            echo $total_assets_processed;
                        }else {
                            echo "0";
                        }
                    ?>
        ...
        <table class="table table-hover custom-table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $pdata["req_reference_no"]??"";?></td>
                    <td><?php echo $pdata["lot_number"]??"";?></td>
                    ...
                    <td><?php echo $pdata["total_po_qty"]??"";?></td>
                    <td><?php echo $pdata["assets_physical_qty"]??"";?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
