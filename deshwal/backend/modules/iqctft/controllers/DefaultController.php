...
namespace backend\modules\iqctft\controllers;

use common\controllers\ModuleController;
use Yii;
/**
 * Default controller for the `iqctft` module
 */
// class DefaultController extends Controller
class DefaultController extends ModuleController
{
    public $layout='multiple';
    public $ModuleName='iqctft';
    public $FieldId='iqctft_id';
    public $TableName='iqc_tft';
    public $TabLabel='IQC TFT';
