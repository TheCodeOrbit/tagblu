...
namespace backend\modules\modelwiseclubbedinventory\controllers;
...
class DefaultController extends ModuleController
{
    ...
    public $ModuleName = 'modelwiseclubbedinventory';
    public $FieldId = 'id';
    public $TableName = 'rep_modelwise_clubbed_inventory';
    public $TabLabel = 'Model wise Clubbed Inventory';
    public $TabId = '123';
    ...
    public function actionFilteroptioncolumn()
    {
        ...
        return [
            ['value' => 'prod_model_value', 'label' => 'Model'],
