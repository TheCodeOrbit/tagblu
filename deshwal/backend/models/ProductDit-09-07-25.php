...
class ProductDit extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['productdit_no', 'product_name', 'product_description', 'hsn_code', 'oem_part_number', 'unit_in_hand', 'opening_stock', 'master_category', 'product_nuture', 'groupid', 'category', 'sub_category', 'oem', 'cost_price', 'gst_percentage', 'seq_no', 'product_dimensions_cm', 'product_weight_kgs'], 'default', 'value' => null],
            ...
            [['productdit_no', 'product_name', 'hsn_code', 'oem_part_number'], 'string', 'max' => 200],
        ];
    }
