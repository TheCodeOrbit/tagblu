...
<?php  } ?>
	...
	<td class="">
		...
		<input type="text" maxlength="25" id="productiontotaldata_0_subgrade_qty" name="productiontotaldata[0][subgrade_qty]" value="<?php echo $productiontotaldata[0]['subgrade_qty']; ?>" readonly class="input-border form-control inputwidth subgrade_qty subgrade_qty_w" >						 
	</td>
	<td class="">
		<div style="display:none" id="productiontotaldata_0_subgrade_lead_em" class="ajxwarning errorMessage tooltip_img"></div>
		<input type="text" maxlength="25" id="productiontotaldata_0_subgrade_lead" name="productiontotaldata[0][subgrade_lead]" value="<?php echo $productiontotaldata[0]['subgrade_lead']; ?>" readonly class="input-border form-control inputwidth subgrade_lead subgrade_lead_w" >						 
	</td>
