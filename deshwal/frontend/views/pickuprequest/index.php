...
as per 24 june 2025 client mail -->
                ...
                <tbody>
                    ...
                    foreach($pickupRequestData as $prd){ 
                        ...
                        $prd['status_value'] = $prd["sourcingdeal_stage"];
                        ?>
                        <tr>
                            <td>
...
as per 24 june 2025 client mail -->
                            ...
                            <td>
                                <?php echo Html::a('View Details', Url::to(['pickuprequest/view', 'pickup_request_id' => $prd["pickup_request_id"]]), ['class' => 'btn btn-info btn-sm']); ?>
                            </td>
                        </tr>
                    <?php } ?>
