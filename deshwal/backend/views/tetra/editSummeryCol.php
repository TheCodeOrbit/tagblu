							...
							'item' => function ($index, $label, $name, $checked, $value) use ($field, $read) {
								return Html::tag(
									...
									Html::checkbox($name, $checked, [
										'value' => $value,
										'class' => 'form-check-input single-edit-model-checkbox ' . $field["typeofdata"] . ' ' . $read, // Custom class for checkbox
				...
				if ($field["mandatory"] == 1) {
					echo Html::{$field["fieldtype"]}(
						...
						[
							'id' => $field["fieldname"],
							'disabled' => $readonly ? true : false,
							"class" => "form-check-input single-edit-model-checkbox " . $field['typeofdata'] . " " . $field["classname"] . " " . $read, // Optional custom CSS class
