														...
														if(count($Multiple_Record->reasons)>0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<?php } ?>
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="<?php echo $Field->tablename;?> without_ampm input-border form-control timeformat <?php echo $Field->tablename;?>_1" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
															...
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="<?php echo $Field->tablename;?> without_ampm input-border form-control timeformat <?php echo $Field->tablename;?>_1" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
														...
														if(count($Multiple_Record->reasons) >0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="<?php echo $Field->tablename;?> timeformat without_ampm input-border form-control" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
