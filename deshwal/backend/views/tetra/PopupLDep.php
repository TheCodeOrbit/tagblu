...
$dependentval=$_REQUEST['dependentval'];	
		        	...
		        	<tr>
		        		...
		        		if(isset($_REQUEST['promod1']) && $_REQUEST['promod1'] == 'promod')
								...
								<tr>
									...
									<td class="cursorPointer data-cell showinParent_server pld" 
...
function filterTable() {
  ...
  showReferenceConditional('<?= $hiddenfield ?>','<?= $refield ?>','<?= $rdisfield; ?>','<?= $mname; ?>','<?= $maintabid;?>','<?= $dependent;?>','<?= $dependentval;?>','<?= $conditionfield;?>''',pageselectval,searchTerms,)
}
