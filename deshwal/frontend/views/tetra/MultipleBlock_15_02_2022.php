						...
						foreach($Record[Multiple_Records][$Block->blockid] as $MPkey=> $Multiple_Record){ $tax_html="";?>
								...
								<?php	if($Field['uitype']==1){
									...
									<td class="<?php echo $Field->td_classname;?>">
										...
										<?php echo $form->textField(${$obj_name},"[$MPkey]$Field->fieldname", array ('class' => $Field->classname . ' input-border form-control','value'=>$Multiple_Record->{$Field->fieldname},'readonly' => $readonly,'onkeyup' => $blastintfunc));?>
														...
														if(count($Multiple_Record->reasons)>0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	<select class="input-border form-control reason w-25" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][reason][]">
																	...
																	<?php } ?>
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="without_ampm input-border form-control timeformat c" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
															<?php } 
														}else{?>
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="without_ampm input-border form-control timeformat b" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
								...
								<?php }elseif($Field['uitype']==8){
									...
									<td class="<?php echo $Field->td_classname;?>">
										...
										<div class="d-flex flex-col">
											<?php echo $form->dropDownList(${$obj_name},"[$MPkey]$Field->fieldname", $Field['fieldoptions'],array('class' => 'h5 input-border p-2 mb-0 b','aria-label'=>'select example','value'=>$Multiple_Record->{$Field->fieldname},'empty'=>'Select an Option','options' => array($Multiple_Record->{$Field->fieldname}=>array('selected'=>true)))); ?>
														...
														if(count($Multiple_Record->reasons) >0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="timeformat without_ampm input-border form-control" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
															<?php } 
														}else{?>
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="without_ampm input-border form-control timeformat a" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
															</div>
														<?php }
														?>
