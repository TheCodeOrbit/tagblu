				...
				<table class="table-view table table-striped">
					<thead>
						<tr class="list-general table-primary">
							...
							<?php endforeach;?>
							<th>Action</th>
							<?php if($ModuleName=="manpower" || $ModuleName=="ehs" || $ModuleName=="water_management" || $ModuleName=="revenue_data"  || $ModuleName=="log_user_details"  || $ModuleName=="users"  || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"){
							}else{?>
								<th>Status</th>
							<?php }?>
							<?php if($ModuleName=="water_management" || $ModuleName=="users" || $ModuleName=="log_user_details" || $ModuleName=="ehs" ||  $ModuleName=="openingstock" ||  $ModuleName=="data_reconciliation" ||  $ModuleName=="p_reconciliation" ||  $ModuleName=="ce_p_reconciliation" ||  $ModuleName=="mnth_close" || $ModuleName=="manpower" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material" || $ModuleName=="revenue_data"){}
					...
					<tbody>
						...
						<?php } else { ?>
							...
							<tr>
								...
								<?php if($ModuleName=="manpower" || $ModuleName=="users" || $ModuleName=="log_user_details" || $ModuleName=="revenue_data"  || $ModuleName=="ehs" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"  || $ModuleName=="water_management"  ){
								}else { ?>
