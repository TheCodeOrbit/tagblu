						...
						<?php } else { ?>
							...
							<tr>
								...
								<?php if ($user_id=='1' ||$user_id=='222' ||$user_id=='217'||$user_id=='208') { ?> 
									...
									<?php } ?>
								<?php if($ModuleName=="manpower" || $ModuleName=="production" || $ModuleName=="users" || $ModuleName=="log_user_details" || $ModuleName=="revenue_data"  || $ModuleName=="ehs" || $ModuleName=="debtors_plan" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"  || $ModuleName=="water_management" || $ModuleName=="other_cost" || $ModuleName=="rake_plan" ){
								}else { ?>
