...
/**
 * This is the model class for table "inspection_full_product_detail".
 *
 ...
 */
class InspectionFullProductDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'inspection_full_product_detail';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['inspection_id', 'prod_category', 'make', 'model', 'generation', 'screen_size', 'ram', 'storage_capacity', 'storage_type', 'screen_broken', 'physical_dent', 'battery_health', 'quantity', 'critical'], 'integer'],
            [['serial_number', 'image_top', 'image_bottom', 'image_open', 'image_screen', 'image_bios', 'image_front','image_back','image_motherboard','remarks'], 'string', 'max' => 200],
        ];
    }
    ...
    public function saveInspectionFullProductDetail($entityId)
    {
        if(empty($_POST['inspection_full_product_detail'])){
            return false;
        }
        // file attach code added by ptpatel on date 23-04-25
        // $attachmentDetails = $_POST['inspection_full_product_detail'];
        $uploadedFiles = $_FILES['inspection_full_product_detail']?? null;
        $grn_items=$_POST['inspection_full_product_detail'];
