...
if (strpos($module, "iqc") === 0) $anyMultipleBlockInModule = true;
  ...
  <div class="records table-responsive">
    <div class="record-header">
      ...
      <div class="">
        ...
        <?php
        if (isset($Record['vertical_manager']) && $Record['vertical_manager'] == Yii::$app->user->id && isset($Record['leadstatus']) && $Record['leadstatus'] != 13) { ?>
        ...
        <?php
        } else if ($Record['ownerid'] == Yii::$app->user->id || Yii::$app->user->id == 1) {
        ...
        ?>
          <div class="div-regroup">
            ...
            ?>
              ...
              if ($TabId == 7) {
                if (($Record['leadstatus'] != '4' && $Record['leadstatus'] != '13')) //can't edit if send for approval or qualified
                { ?>
                        ...
                        foreach ($Block->detailfields as $field) { ?>
                          ...
                          ?>
                            ...
                            <div class="col-md-6 mb-3">
                              <div class="d-flex">
                                <div class="field-lable col-4"><?= $field["fieldlabel"]; ?></div>
                            ...
                            if ($field["uitype"] == 12 || $field["uitype"] == 27 || $field["uitype"] == 28) {
                              ...
                              if ($Record->{$field["columnname"]}) {
                                if ($field["columnname"] == 'profilepic') {
                                  $filepath =  $Record->{$field["columnname"]};
                                } else {
                                  $records = \app\models\Attachments::find()
                                    ->where(['attachmentsid' => $Record->{$field["columnname"]}])
                                    ->one();
