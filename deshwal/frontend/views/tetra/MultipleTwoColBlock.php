<style>
	...
	.body-container {
		height: auto;
		max-height: var(--space-main-body);
	}
</style>
...
<?php if($Block->blocklable){ //echo $Block->blocktype;
		//echo $Block->blockid;
	?>
	<div style="height: max-content;" class="body-outline mb-3 <?php 
	if ($Block->blockid==110) { 
		echo "data-simplebar";
	}elseif ($Block->blockid==111) {
		echo "data-simplebar";
	}
	elseif ($Block->blockid==34) { 
		...
		echo "coal-grid-table-6";
					...
					<thead>
						...
						<tr>
							...
							foreach ($Block->Fields as $key=> $Field): ?>
								...
								<th style="<?php if($count==1){echo 'width:150px';}?>"><?php echo $Field->fieldlable;?></th>
							<?php $count++;
						endforeach;?>
				...
				<tbody id="prodlist_<?php echo $obj_name;?>" class="">
					<?php
 	...
 	<?php } else {?>
				<div class="body-outline h-auto <?php 
	if ($Block->blockid==110) { 
		echo "data-simplebar";
	}elseif ($Block->blockid==111) {
		echo "data-simplebar";
														...
														if(count($Multiple_Record->reasons) >0){
															...
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="without_ampm input-border timeformat form-control" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
															</div>
														<?php }
														?>
