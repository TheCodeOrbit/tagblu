        ...
        fSelect.prototype = {
            ...
            reload: function() {
                if (this.settings.showButtons && this.settings.multiple) {
                    var search = '<div class="fs-buttons"><div><div class="fs-button fs-select-all">' + this.settings.selectAllText + '</div></div><div><div class="fs-button fs-deselect-all">' + this.settings.deselectAllText + '</div></div></div>';
