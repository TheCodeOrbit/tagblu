...
<?php	}}
	?>
	<div>
	<div data-simplebar class="body-outline mb-3 h-auto <?php if($Block->blockid==34 || $Block->blockid==35 || $Block->blockid==36){echo "width-30perc";}elseif($Block->blockid==37 || $Block->blockid==38){echo "w-50";}else{}?>">
