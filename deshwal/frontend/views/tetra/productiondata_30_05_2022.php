...
//$MineName="<script>mine_name<script>";
 foreach ($ALLLIST as $key=>$productiondata) { ?>
	...
	<td class="">
		...
		<input type="text" maxlength="25" id="productiondata_<?php echo $key;?>_washed_coal_production" name="productiondata[<?php echo $key;?>][washed_coal_production]" value="<?php echo $productiondata['washed_coal_production']; ?>" class="input-border form-control washed_coal_production washed_coal_production_w" readonly>						
	</td>
	...
	<td class="">
		...
		<input type="text" maxlength="25" id="productiondata_<?php echo $key;?>_reject_production" name="productiondata[<?php echo $key;?>][reject_production]" value="<?php echo $productiondata['reject_production']; ?>" readonly class="input-border form-control reject_production reject_production_w" >						
	</td>
...
<td class="<?php print_r($productiondata);?>">
