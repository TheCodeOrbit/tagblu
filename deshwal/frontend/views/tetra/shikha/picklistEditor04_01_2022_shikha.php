    ...
    <div class="body-container d-flex flex-col justify-content-center align-items-center"><!-- Main List Body div-->
        ...
        <div class="body-outline general-list height-full-body">
            ...
            <div class="body-footer d-flex justify-content-end align-items-center mx-3 ">
                <div class="add-btn list-view-add-btn btn-primary d-flex justify-content-center align-items-center position-static btn picklist-btn" data-toggle="modal" data-target="#exampleModal">
...
<input type="text" class="input-border" id="item_value">
			...
			<div class="d-flex">
			<div class="input-heading">
			<label for="EditModel_user_name">Item Value</label>	
			</div>
			<input autocomplete="new-password" class="input-border simple-table__container__input" value="" name="EditModel[user_name]" id="EditModel_user_name" type="text"><div class="ajxwarning errorMessage error-container" id="EditModel_user_name_em_" style="display:none"></div>										</div>
			</form> -->
