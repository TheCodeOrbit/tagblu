...
<div>
    ...
    <div class="body-container d-flex flex-col justify-content-center align-items-center"><!-- Main List Body div-->
        <div class="simple-table d-flex justify-content-between">
			<div class="simple-table__container" style="">
				<div class="d-flex justify-content-between gap-1rem">
                    ...
                    <select class="header-elements" name="Tab_tabid" id="Tab_tabid">
				...
				<div class="d-flex justify-content-between gap-1rem">
                    <div class="input-heading">
                        <label for="">Picklists in the Module</label>
					</div>
                    <select name="picklist" class="header-elements" id="ropDownCars">
                        <option value="default">Select</option>
                        <option value="1">User</option>
                    </select>
					<div class="ajxwarning errorMessage error-container" id="" style="display:none">
        ...
        <div class="body-outline general-list height-full-body">
            ...
            <div class="body-footer d-flex justify-content-end align-items-center mx-3 ">
                <div class="add-btn list-view-add-btn btn-primary d-flex justify-content-center align-items-center position-static btn picklist-btn add_data_btn" data-toggle="modal" data-target="#assign-value" data-id=""  data-tab="">
...
<div class="modal fade" id="assign-value" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog  modal-dialog-centered">
<div class="modal-content">

<div class="modal-header jc-cntr">
<h5 class="modal-title text-center body-heading" id="exampleModalLabel">Add Picklist Item</h5>
</div>

<div class="modal-body">
<form class="form form-horizontal" action="" name="" role="form">
<div class="d-flex justify-content-between mb-3">
<label class="input-heading" for="newName">Item Value</label>
<div class="col-sm-7">
<input type="text" class="input-border" id="item_value">
</div>
</div>
</form>
</div>
...
<h4 class="modal-title">Edit PickList Item</h4>
</div>
<div class="modal-body">
...
<input type="text" class="input-border" id="item_value" value="">
...
<input type="text" class="form-control" id="item_value">
			...
			<input class="btn btn-primary input-save me-5 close bottomsavebtn" id="addvaluesubmit" type="submit" value="Submit">
			<a href="#" data-dismiss="modal" class="btn addgrpcancel btn-danger input-save" id="canceladditem">Discard</a>
...
<!-- Trigger Classes for Modal : data-bs-toggle="modal" data-bs-target="#exampleModal" -->
<div class="modal fade" id="#rename-value" tabindex="-1" aria-labelledby="#rename-value" aria-hidden="true">
    <!-- Todo: Onclick of Submit Show this alert -->
	<div class="alert alert-success alert-dismissible fade hide" role="alert">
		Data Saved Successfully
	</div>
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
			<form class="form form-horizontal" action="<?php echo $baseurl ?>/Pick/AddItem" method="post" name="" role="form">
			<div class="d-flex">

            <div class="input-heading">
            <label for="newName">Item Value</label>
            </div>
            <input type="text" class="input-border" id="item_value" name="item_value" value="">
                                    </div>
            </form>
			...
			<a class="btn btn-primary input-save me-5 close bottomsavebtn" id="addvaluesubmit">Submit</a>
			<a href="#" data-dismiss="modal" class="btn addgrpcancel btn-danger input-save" id="canceladditem">Discard</a>
			
			<!-- <input class="btn btn-primary input-save me-5 close bottomsavebtn" id="addvaluesubmit" type="submit" name="yt0" value="Submit">	
...
<!-- Start of Test modal  -->
<div class="modal fade" id="exampleModalTest" tabindex="-1" aria-labelledby="exampleModalLabelTest_" aria-hidden="true">
    <!-- Todo: Onclick of Submit Show this alert -->
	<div class="alert alert-success alert-dismissible fade hide" role="alert">
		Test modal opening
	</div>
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="modal-header jc-cntr">
				<h5 class="modal-title text-center body-heading" id="exampleModalLabelTest_">Testing picklist modal</h5>
			</div>
			<div class="modal-body">
			<form class="form form-horizontal" action="" name="" role="form">
			<div class="d-flex">
...
<input type="text" class="input-border" id="item_value">
			...
			<a class="btn btn-primary input-save me-5 close bottomsavebtn" id="">Submit</a>
			<a href="#" data-dismiss="modal" class="btn addgrpcancel btn-danger input-save" id="">Discard</a>
			</div>
		</div>
	</div>
</div>
...
<script>
// id=$('#Tab_tabid').val();
// //$('.add_data_btn').attr("data-tab",id); //setter

// $('#Tab_tabid').on('change', function(){

//     let id = $(this).find(':selected').val();
//     //$('.add_data_btn').attr(data-id,id);  
//     $('.add_data_btn').attr("data-tab",id); //setter
...
//   $(document.body).on('click', '.add_data_btn' ,function(){
...
//   $(document.body).on('click', '#addvaluesubmit1' ,function(){
//       alert("dd");
// var item_value   =   $("#item_value").val();
// var module    =   $("#Tab_tabid").val();
// var picklist  =   $("#ropDownCars").val();
