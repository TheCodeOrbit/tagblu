...
namespace backend\modules\billingfromaddress\controllers;
...
class DefaultController extends ModuleController
{
    ...
    public $ModuleName = 'billingfromaddress';
    public $FieldId = 'billingfromaddress_id';
    public $TableName = 'billing_from_address';
    public $TabLabel = 'Billing From Address';
    public $TabId = '86';
    /**
