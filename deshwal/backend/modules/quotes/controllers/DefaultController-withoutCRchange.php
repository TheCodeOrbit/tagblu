...
// }
    ...
    public function actionGetvendorlocation()
    {
        ...
        $command = $connection->createCommand("
                        SELECT legal_entity_name,address,state.state_value as state,state.state_code,gstin_no_uin,pincode,pan_no,city.city_name as city FROM vendor_locations 
...
where quotes_id = :Record";
        ...
        <tr>
          <td width="50%" align="center" style="border: 0.5mm solid #e6e2d2;">
            <b>Billing Address</b>
        ...
        <tr>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;">$bill_legal_name            
          </td>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;">Deshwal Waste Management Pvt. Ltd.           
          </td>
        </tr>
        <tr>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;">$bill_address
          </td>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;">$warehouse_address
          </td>
        </tr>
        <tr>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;">$bill_city, $bill_state, $bill_pincode.
          </td>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;">$warehouse_city, $warehouse_state, $warehouse_pincode
          </td>
        </tr>
        <tr>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;"><b>GSTIN: $bill_gstin_no_uin</b>
          </td>
          <td width="50%" style="border: 0.5mm solid #e6e2d2;"><b>GSTIN: $warehouse_gstin_no</b>
          </td>
        </tr>
        </table>
...
EOD;
        ...
        <table>
            ...
            <tr>
                <td align="left" width="80%" style="font-size:8px">$terms_and_conditions
                </td>
                <td></td>
            </tr>
        </table>
