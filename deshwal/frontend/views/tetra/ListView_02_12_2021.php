		...
		<div><!-- Wrapper for scroll -->
			...
			<div class="body-menu d-flex justify-content-between">
				...
				<div class="body-outline general-list height-full-body">
					...
					<div class="body-footer d-flex justify-content-between align-items-center mx-2rem position-relative">
						<!-- pagination -->
						<?php include_once "ListViewPagination.php";?>					
						<div class="add-btn btn-primary d-flex justify-content-center align-items-center position-absolute bottom-0 end-0 translate-middle-y">
