...
<?php
						//added by deepika on 03/03/2023 for pekb road dispatch
							if($MineName == '1')
							{

			echo "<input type='hidden' name='reject_coal_dispatch[0][location]' value ='31'>";
		
			echo "<input type='hidden' name='reject_coal_dispatch[0][destination]' value ='0'>";
		
			echo "<input type='hidden' name='reject_coal_dispatch[0][customer_name]' value ='0'>";
		
			echo "<input type='hidden' name='reject_coal_dispatch[0][destination_location]' value ='0'>";
	}
			?>			
		...
		<div class="body-outline mb-3 h-auto" <?php 
	if ($Block->blockid==110 || $Block->blockid==111 ) { 
		echo "data-simplebar";
	}?> >
...
<!-- 												<input type="hidden" value="<?php echo $MineName; ?>" id="mine_name" name="EditModel[mine_name]"/>
 -->
							<?php if($Block->blockid==3 || $Block->blockid==5 || $Block->blockid==96){}else{?>
							<tr>
								<th colspan="20" class="bg-prim">
									<div class="input-heading bg-inherit d-flex justify-content-center align-items-center" style="padding:0px;">
										<?php if($Block->blockid==3 || $Block->blockid==5 || $Block->blockid==93){}else{ ?>
											...
											//if($Block->blockid==19 || $Block->blockid==89 || $Block->blockid==21 || $Block->blockid==79 || $Block->blockid==80){
											
											if($Block->blocktype=="Multiple" && ($Block->blockid!=69 || $MineName != "1")){//added "&& $Block->blockid!=69" by deepika for roal dispatch pekb

												?>

											<div class="me-1">
												<div class="btn-primary add-btn d-flex jc-cntr align-items-center position-static p-2 rounded" id="Add<?php echo $obj_name;?>" rel="<?php echo $Block->blockid;?>">
													<svg width="10" height="10" viewBox="0 0 16 16">
														<path d="M6 16H10V10H16V6H10V0H6V6H0V10H6V16Z" fill="#ffffff"/>
													</svg>                        
													<span class="ms-2">ADD<?php //echo $Block->blockid; ?></span>
												</div>
											</div>
											<?php } ?>
										<?php } ?>
...
<?php } ?>
						<tr>
							...
							<?php foreach ($Block->Fields as $key=> $Field): ?>
								<?php if($Field->fieldid==1861 || $Field->fieldid==1860 || $Field->fieldid==1862){
									$cls="w-150px";
								}else{
									$cls="";
							...
							<th class="<?php echo $cls;?>"><?php echo $Field->fieldlable;?></th>
							<?php 
					...
					<tbody id="prodlist_<?php echo $obj_name;?>">
						...
						// if($ModuleName=='rake_plan' && $ActionName=="Create"){
						// 	$this->productBlockEHS('1',$Block->blockid);
						// }
						?>
						<?php
...
?>
									<td class="<?php echo $Field->td_classname;?>">
										...
										<?php echo $form->textField(${$obj_name},"[$MPkey]$Field->fieldname", array ('class' => $Field->classname.' '.$timeformat. ' input-border form-control','value'=>$Multiple_Record->{$Field->fieldname},'readonly' => $readonly,'placeholder'=>$p_holder,'onkeyup' => $blastintfunc));?>
								...
								<?php }elseif($Field['uitype']==14){ 
									...
									<td>
									<button type="button" value="Stoppage reason"  class="btn btn-primary form-control target-button" data-bs-toggle="modal" data-bs-target="#<?php echo $obj_name.'_'.$reason_counter.'_'.$Field->fieldname.'_reason'; ?>">Stoppage<i class="pe-none"></i></button>
												...
												<!-- <div class="body-outline h-auto"> -->
													<div class="modal-body position-relative" data-que="<?php echo $reason_counter;?>">
														<div class="d-flex justify-content-between">
															...
															<div class="input-heading " style="width:9%">Tools</div>
														</div>
														 <?php 
														// echo "<pre>";
														// print_r($Multiple_Record);
														if(count($Multiple_Record->reasons)>0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	<select class="input-border form-control reason" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][reason][]">
																	...
																	<input type="text" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][other_reason][]" class="form-control input-border other_reason" placeholder="Reason" value="<?php echo $reason_record->other_reason; ?>" >
																	<?php } ?>
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="<?php echo $Field->tablename;?> without_ampm input-border form-control timeformat <?php echo $Field->tablename;?>_1 <?php echo $Field->tablename;?>_loss_hours" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																	<div class="action-icon-container input-border w-150px <?php echo $Field->tablename;?>reason_delete"><svg viewBox="0 0 18 19" class="action-icon action-icon--delete"><path d="M5.14414 15.2656H12.8539L13.2793 6.26562H4.71875L5.14414 15.2656Z"></path><path d="M15.1875 5H12.9375V3.59375C12.9375 2.97324 12.433 2.46875 11.8125 2.46875H6.1875C5.56699 2.46875 5.0625 2.97324 5.0625 3.59375V5H2.8125C2.50137 5 2.25 5.25137 2.25 5.5625V6.125C2.25 6.20234 2.31328 6.26562 2.39062 6.26562H3.45234L3.88652 15.459C3.91465 16.0584 4.41035 16.5312 5.00977 16.5312H12.9902C13.5914 16.5312 14.0854 16.0602 14.1135 15.459L14.5477 6.26562H15.6094C15.6867 6.26562 15.75 6.20234 15.75 6.125V5.5625C15.75 5.25137 15.4986 5 15.1875 5ZM6.32812 3.73438H11.6719V5H6.32812V3.73438ZM12.8549 15.2656H5.14512L4.71973 6.26562H13.2803L12.8549 15.2656Z"></path></svg></div>
																</div>
															<?php } 
														}else{?>
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="<?php echo $Field->tablename;?> without_ampm input-border form-control timeformat <?php echo $Field->tablename;?>_1 <?php echo $Field->tablename;?>_loss_hours" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																	<div class="action-icon-container input-border w-120px <?php echo $Field->tablename;?>reason_delete"><svg viewBox="0 0 18 19" class="action-icon action-icon--delete"><path d="M5.14414 15.2656H12.8539L13.2793 6.26562H4.71875L5.14414 15.2656Z"></path><path d="M15.1875 5H12.9375V3.59375C12.9375 2.97324 12.433 2.46875 11.8125 2.46875H6.1875C5.56699 2.46875 5.0625 2.97324 5.0625 3.59375V5H2.8125C2.50137 5 2.25 5.25137 2.25 5.5625V6.125C2.25 6.20234 2.31328 6.26562 2.39062 6.26562H3.45234L3.88652 15.459C3.91465 16.0584 4.41035 16.5312 5.00977 16.5312H12.9902C13.5914 16.5312 14.0854 16.0602 14.1135 15.459L14.5477 6.26562H15.6094C15.6867 6.26562 15.75 6.20234 15.75 6.125V5.5625C15.75 5.25137 15.4986 5 15.1875 5ZM6.32812 3.73438H11.6719V5H6.32812V3.73438ZM12.8549 15.2656H5.14512L4.71973 6.26562H13.2803L12.8549 15.2656Z"></path></svg></div>
																</div>
								...
								<?php $reason_counter++;}elseif($Field['uitype']==13){if($Field->fieldname=='from_date' || $Field->fieldname=='to_date'){$MPkeys =$MPkey;}else{$MPkeys =$MPkey+1;} ?>
								<td>
								...
								<?php }elseif($Field['uitype']==8){
									...
									<td class="<?php echo $Field->td_classname;?>">
										...
										<div class="d-flex flex-col">
											<?php echo $form->dropDownList(${$obj_name},"[$MPkey]$Field->fieldname", $Field['fieldoptions'],array('class' => $Field->fieldname.' h5 input-border p-2 mb-0 b','aria-label'=>'select example','value'=>$Multiple_Record->{$Field->fieldname},'empty'=>'Select an Option','options' => array($Multiple_Record->{$Field->fieldname}=>array('selected'=>true)))); ?>
						...
						<?php 
						if($Block->blocktype!="Multiple"  || $Block->blockid==3  || $Block->blockid==5  || $Block->blockid==92 || $Block->blockid==96 || $Block->blockid==101){
						//if($Block->blockid==19 || $Block->blockid==89 || $Block->blockid==21 || $Block->blockid==79 || $Block->blockid==80){}else{?>
			...
			<?php } else {?>
				...
				<div class="body-outline h-auto">
				<?php if($Block->blockid==3 || $Block->blockid==101 || $Block->blockid==96){}else{?>

					<div class="input-heading" style="padding:0px;"><?php echo $Block->blocklable;?></div>
			<?php } ?>
					...
					<table id="Tbl_<?php echo $obj_name;?>">
						<tr>
							...
							<?php endforeach;?>
													<?php //if($ActionName=="Create"){ ?>
							<th class="deleteTool">Tools <?php //echo $Block->blockid;?></th>
													<?php //}?>
						...
						foreach($Record[Multiple_Records][$Block->blockid] as $MPkey=> $Multiple_Record){ $tax_html="";?>
								...
								<?php	if($Field['uitype']==1){
									...
									<td class="<?php echo $Field->td_classname;?>">
										...
										//echo "a".$Field->fieldid; 
										if($Field->fieldid==1899 || $Field->fieldid==2081){
										$timeformat='timeformat';
										$p_holder='hh:mm';
									}else{
										$timeformat='';
									...
									<td class="<?php echo $Field->td_classname;?>">
										...
										?>	
										<?php echo $form->error(${$obj_name},"[$MPkey]$Field->fieldname", array('class'=>'ajxwarning errorMessage tooltip_img')); ?>				
										<?php echo $form->textField(${$obj_name},"[$MPkey]$Field->fieldname", array ('class' => $Field->classname . $timeformat.' input-border form-control', 'placeholder'=>$p_holder,'value'=>$Multiple_Record->{$Field->fieldname},'readonly' => $readonly,'onkeyup' => $blastintfunc));?>
										<div class="error-container hide">All errors displayed Here</div>
									</td>
								...
								<?php }elseif($Field['uitype']==14){ ?>
									<td>
									<button type="button" value="Stoppage reason"  class="btn btn-primary form-control target-button" data-bs-toggle="modal" data-bs-target="#<?php echo $obj_name.'_'.$reason_counter.'_'.$Field->fieldname.'_reason'; ?>">Stoppage</button>
														...
														if(count($Multiple_Record->reasons) >0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="<?php echo $Field->tablename;?> timeformat without_ampm input-border form-control <?php echo $Field->tablename;?>_loss_hours" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
															...
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="<?php echo $Field->tablename;?> without_ampm input-border form-control timeformat a" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																	<div class="action-icon-container input-border disabled w-120px"><svg viewBox="0 0 18 19" class="action-icon action-icon--delete"><path d="M5.14414 15.2656H12.8539L13.2793 6.26562H4.71875L5.14414 15.2656Z"></path><path d="M15.1875 5H12.9375V3.59375C12.9375 2.97324 12.433 2.46875 11.8125 2.46875H6.1875C5.56699 2.46875 5.0625 2.97324 5.0625 3.59375V5H2.8125C2.50137 5 2.25 5.25137 2.25 5.5625V6.125C2.25 6.20234 2.31328 6.26562 2.39062 6.26562H3.45234L3.88652 15.459C3.91465 16.0584 4.41035 16.5312 5.00977 16.5312H12.9902C13.5914 16.5312 14.0854 16.0602 14.1135 15.459L14.5477 6.26562H15.6094C15.6867 6.26562 15.75 6.20234 15.75 6.125V5.5625C15.75 5.25137 15.4986 5 15.1875 5ZM6.32812 3.73438H11.6719V5H6.32812V3.73438ZM12.8549 15.2656H5.14512L4.71973 6.26562H13.2803L12.8549 15.2656Z"></path></svg></div>
																</div>
															</div>
														<?php }
