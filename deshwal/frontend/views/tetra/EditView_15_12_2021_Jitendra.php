 ...
 <div id="AddDrill" class="">
			...
			<div class="body-container">
				...
				<?php if($Block->blocktype=="SimpleTwoCol"){  //echo "Two column"; ?>
					...
					<div class="body-outline h-auto mb-5">
						<?php } ?>
						<div class="input-heading mt-4 mb-2" style="margin-right:2.8rem;margin-left:2.8rem"><?php echo $Block->blocklable;?></div>
							...
							<div class="simple-table__container" style="<?php if($Block->blockid !=6){ echo 'border:none' ;}?>">
								<?php $counter=0;foreach($Block->Fields as $field){ 
									if($counter%2 == 0){?>
										...
										<div class="input-heading simple-table__container__heading"><?php echo $form->labelEx($model,$field['fieldname'], array ()); ?></div>
    ...
    <?php }?>
	  ...
	  <?php if($ModuleType!="Related"){?>
		...
		<svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" data-toggle="modal" data-target="#myModal22" onclick="showCustomer1('<?php echo $fieldname2 ;?>','<?php echo $fieldname;?>','<?php echo $fieldname3;?>','customername','<?php echo $ModuleName; ?>','<?php echo $multiplebloackid ; ?>','<?php echo $multipleobjname;?>','<?php echo $Block->blockid; ?>')">
													...
													<div class="modal-content">
														<div class="body-outline h-auto">
															...
															<div class="d-flex">
																...
																<button type="button" class="btn btn-outline-danger btn-custom me-5 modal-data-dismiss" data-dismiss="modal">Close</button>
															</div>
														</div>	
													</div>
												</div>
