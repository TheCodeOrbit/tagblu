...
<td class="record-value">
	...
	<input type="hidden" value="17" id="uitype" name="uitype"/>
	<?php
	...
	?>
	<input type="hidden"  value="<?php echo $dt; ?>" id="<?php echo 'EditModel_'.$field['fieldname']; ?>" name="<?php echo 'EditModel['.$field['fieldname'].']'; ?>" />
	<input type="text"  value="<?php echo $Record[$field['fieldname']]; ?>" readonly id="<?php echo $field['fieldname']; ?>" name="<?php echo $field['fieldname']; ?>" class="<?php echo $field['classname'] ?>" autocomplete="off" />
</td>