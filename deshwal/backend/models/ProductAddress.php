...
class ProductAddress extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ownerid', 'pickupaddress_no', 'contractid', 'location_name', 'address', 'city', 'state', 'pin_code', 'spoc_name', 'email', 'phone_no'], 'default', 'value' => null],
            [['deleted'], 'default', 'value' => 0],
            [['ownerid', 'creatorid', 'modifiedby', 'contractid', 'location_name', 'city', 'state', 'deleted'], 'integer'],
