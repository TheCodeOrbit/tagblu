...
<nav aria-label="breadcrumb" class="mt-2">
    <ol class="breadcrumb rounded-3">
        ...
        <li class="breadcrumb-item">
            <a class="link-body-emphasis text-decoration-none gray-shade-2-breadcrum">Drillng</a>
        </li>
    </ol>
</nav>
 <h4>Overview</h4>
        ...
        <table class="table table-hover custom-table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-module="drilling" <?php if($pdata["status"] == 5){?> data-request-id="<?php echo $pdata["drilling_id"]??"";?>" data-bs-toggle="modal" data-bs-target="#drillingModal" <?php }?>><span class="<?php echo $status_class;?>"><?php echo $pdata["status_name"]??"";?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
...
<div class="modal fade" id="drillingModal" tabindex="-1" aria-labelledby="drillingLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="drillingLabel">Drilling</h1>
