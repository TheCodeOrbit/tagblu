...
if ($TabId == 7 && $Record['ownerid'] == Yii::$app->user->id && isset($Record['leadstatus']) && ($Record['leadstatus'] == 4 || $Record['leadstatus'] == 5)) {
    ...
    <?php
} else if ($TabId == 13 && ($Record['stage']) && ($Record['stage'] == 2 && ($role != "H19" && $role != "H63" && Yii::$app->user->id != 1 && $hasadminpower != 1))) {
                /**
...
if ($TabId == 14 && isset($ApproveSalesOrder) && $ApproveSalesOrder == 1) { //salesorder 
    ...
    ?>
        ...
        <?php endif ?>
            ...
            if ($TabId == 72 && (($Record['quote_stage']) && ($Record['quote_stage'] == 4))) {
                ?>
            ...
            if ($TabId == 78 && (($Record['stage']) && ($Record['stage'] == 4))) {
                ?>
        ...
        <?php }
            ...
            if ($layout == 'multiple' || $layout == 'single') {
                ...
                } else if ($TabId == 72 && (($Record['quote_stage']) && ($Record['quote_stage'] == 4))) {
