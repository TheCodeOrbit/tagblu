...
class Quotes extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mobile', 'qu_bill_pin_code', 'qu_bill_state_code'], 'string', 'max' => 20],
