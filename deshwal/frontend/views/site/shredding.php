...
<nav aria-label="breadcrumb" class="mt-2">
    <ol class="breadcrumb rounded-3">
        ...
        <li class="breadcrumb-item">
            <a class="link-body-emphasis text-decoration-none gray-shade-2-breadcrum">Shredding</a>
        </li>
    </ol>
</nav>
 <h4>Overview</h4>
        ...
        <table class="table table-hover custom-table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-module="shredding" <?php if($pdata["status"] == 5){?> data-request-id="<?php echo $pdata["shredding_id"]??"";?>" data-bs-toggle="modal" data-bs-target="#shreddingModal" <?php }?>><span class="<?php echo $status_class;?>"><?php echo $pdata["status_name"]??"";?></span></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
...
<div class="modal fade" id="shreddingModal" tabindex="-1" aria-labelledby="shreddingLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="shreddingLabel">Shredding</h1>
