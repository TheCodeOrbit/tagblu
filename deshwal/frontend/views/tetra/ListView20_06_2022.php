				...
				<table class="table-view table table-striped">
					<thead>
						<tr class="list-general table-primary">
							...
							<th>Action</th>
							<?php } ?>
							<?php if($ModuleName=="manpower" || $ModuleName=="ehs" || $ModuleName=="water_management" || $ModuleName=="revenue_data"  || $ModuleName=="log_user_details"  || $ModuleName=="production" || $ModuleName=="users"  || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material" || $ModuleName=="other_cost" || $ModuleName=="rake_plan"){
							}else{?>
								<th>Status</th>
							<?php }?>
						...
						<?php } else { ?>
							...
							<tr>
								...
								<?php if ($user_id=='1' ||$user_id=='222' ||$user_id=='217'||$user_id=='208') { ?> 
									...
									<?php } ?>
								<?php if($ModuleName=="manpower" || $ModuleName=="production" || $ModuleName=="users" || $ModuleName=="log_user_details" || $ModuleName=="revenue_data"  || $ModuleName=="ehs" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"  || $ModuleName=="water_management" || $ModuleName=="other_cost" || $ModuleName=="rake_plan" ){
								}else { ?>
