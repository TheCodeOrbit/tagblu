														...
														if(count($Multiple_Record->reasons)>0){
															foreach($Multiple_Record->reasons as $reason_record){ ?>
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" value="<?php echo $reason_record->loss_hour; ?>" class="without_ampm input-border form-control timeformat" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
															<?php } 
														}else{?>
															<div class="position-relative">
																<div class="d-flex justify-content-between anchor-class">
																	...
																	<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="without_ampm input-border form-control timeformat" name="<?php echo $Field->tablename;?>[<?php echo $reason_counter;?>][loss_hour][]">
																</div>
