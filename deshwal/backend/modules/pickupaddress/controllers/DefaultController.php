...
namespace backend\modules\pickupaddress\controllers;
...
class DefaultController extends ModuleController
{
    ...
    public $ModuleName = 'pickupaddress';
    public $FieldId = 'pickupaddress_id';
    public $TableName = 'pickup_address';
    public $TabLabel = 'Pickup Address';
    public $TabId = '83';
    /**
    ...
    public function actionGetaddressdetail()
    {
        ...
        $command = $connection->createCommand("
                         SELECT  concat(building_name,', ',area_sector_name,', ',floor,', ',landmark) as address,state_value,city_name,vendor_locations.state,city,pincode from vendor_locations
