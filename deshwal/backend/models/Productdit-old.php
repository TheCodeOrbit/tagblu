...
class ProductDit extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ownerid', 'creatorid', 'modifiedby', 'unit_in_hand', 'opening_stock', 'master_category', 'product_nuture', 'groupid', 'category', 'sub_category', 'oem', 'seq_no', 'deleted'], 'integer'],
            [['createdtime', 'modifiedtime'], 'safe'],
            [['product_description'], 'string'],
            [['cost_price', 'gst_percentage'], 'number'],
