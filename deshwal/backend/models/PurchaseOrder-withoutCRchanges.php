 ...
 * @property int|null $warehouse_gstin_no
...
class PurchaseOrder extends \yii\db\ActiveRecord
{
    ...
    public function validateDataIntegrityForPoApproval($stage)
    {
            ...
            if((int)$total_amount_of_items != (int)$basic_cp){
                throw new Exception("Total Amount of Purchase Order do not match with the Basic CP of all Items. Please check the submitted data");
            }
