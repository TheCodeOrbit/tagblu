	...
	<div id="rightside-main">
		...
		<div><!-- Wrapper for scroll -->
			...
			<div class="body-menu d-flex justify-content-between">
                <div>
                    <p class="body-heading">List <?php echo ucfirst($ModuleLabel); ?> Data</p>
                </div>
			...
			<?php //echo "<br>Operation opt=".$operation['opt'];
				...
				if(in_array('5',$val) or $operation['opt'] =='1') {
					if($ModuleName=="water_management" || $ModuleName=="ehs" || $ModuleName=="debtors"  || $ModuleName=="manpower" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material"){}else{
					?>			
				...
				<div class="body-outline general-list height-full-body" style="width:<?php echo $width;?>">
					<div data-simplebar class="adjusted-height">
						...
						<thead>
							...
							<!-- <form name="listsearchfm_master" sss id="listsearchfm_master" action="<?php echo $url;?>" method="POST"> -->
							...
							<tr>
								...
								/*echo $form->field($model, 'demo', [
									'template' => '{$listserchvals['vals']}'
								]);*/
								//echo $form->field($listserchvals['vals']);
								//include_once "ListViewHeader.php";
								echo $listserchvals['vals']; 
								?>
								<th><button type="button" class="btn btn-primary btn-custom" id="listsearch" name="listsearch" onclick="listsearchfm_master.submit();">Search</button></th>
							</tr>
							<?php echo CHtml::endForm();?>
