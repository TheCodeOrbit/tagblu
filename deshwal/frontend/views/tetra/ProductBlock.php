...
if($Block->Fields[0]->tablename=="data_obremoval" or $Block->Fields[0]->tablename=="data_obremoval_big" or $Block->Fields[0]->tablename=="coal_extraction_data" or $Block->Fields[0]->tablename=="ob_loss_hours_production" or $Block->Fields[0]->tablename=="ob_loss_production_hours")
						...
						<div class="modal-body" data-que="<?php echo $cnt_multiple_product;?>">
								...
								<div class="position-relative">
									<div class="d-flex justify-content-between anchor-class">
										...
										<input placeholder="hh:mm" maxlength="8" pattern="^((\d+:)?\d+:)?\d*$" class="<?php echo $Field->tablename;?> input-border form-control timeformat <?php echo $Field->tablename;?>_loss_hours <?php echo $Field->tablename;?>_<?php echo $cnt_multiple_product;?> " name="<?php echo $Field->tablename;?>[<?php echo $cnt_multiple_product;?>][loss_hour][]" <?php echo $Field->fieldid;?> >
