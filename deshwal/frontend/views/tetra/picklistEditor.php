    ...
    <div class="body-container d-flex flex-col justify-content-center align-items-center"><!-- Main List Body div-->
        <div class="simple-table d-flex justify-content-between">
			<div class="simple-table__container" style="">
				<div class="d-flex justify-content-between gap-1rem">
					<div class="input-heading d-flex justify-content-center align-items-center h5 w-120px">
						<label>Module</label>
					</div>
                    <select name="Tab_tabid" id="Tab_tabid" class="header-elements w-150px">
                        <option value="-1">Select</option>
                        <?php foreach($tabs as $tab) { 
                            if($tab['tabid']==25 || $tab['tabid']==26 || $tab['tabid']==27 || $tab['tabid']==28 || $tab['tabid']==29 || $tab['tabid']==30 || $tab['tabid']==56 || $tab['tabid']==57 ){}else{
                            ?>
				...
				<div class="d-flex justify-content-between gap-1rem">
                    ...
                    <select name="picklist" id="ropDownCars" class="header-elements w-150px">
        ...
        <div class="body-outline general-list height-full-body" >
            ...
            <div class="body-footer d-flex justify-content-evenly align-items-center mx-3">
                <div class="action-icon-container add-btn list-view-add-btn btn-primary d-flex justify-content-center align-items-center position-static" data-bs-toggle="modal" data-bs-target="#assign-value">
                ...
                <div class="action-icon-container list-view-add-btn btn-primary d-flex justify-content-center align-items-center position-static" id="rename_val" data-bs-toggle="modal" data-bs-target="#rename-value">
                    <div class="action-icon-container-label">
                        <span>Rename</span>
                    </div>
...
<form class="" action="" name="" role="form">
<div class="d-flex justify-content-between mb-1 gap-1rem">
<div class="input-heading w-50 h5" style="line-height: 2;">
<label for="newName">Item Value</label>
</div>
<input type="text" class="input-border w-50 form-control" id="item_value">
</div>
</form>
</div>
...
<div class="modal-body">
<form method="POST" enctype="multipart/form-data" class="" action="" name="" role="form">
<div class="d-flex justify-content-between mb-1 gap-1rem">
    <div class="input-heading w-50 h5" style="line-height: 2;">
        <label for="renameItem">Item to Rename</label>
    </div>
<!-- <div class="col-sm-7 tab_idone"> -->
<select id="sam" class="chosen-select form-select w-50" data-placeholder="Select Role Name"></select>
<!-- </div> -->
</div>
<div class="d-flex justify-content-between mb-1 gap-1rem">
<div class="input-heading w-50 h5" style="line-height: 2;">
...
<!-- <div class="col-sm-7"> -->
<input type="text" class="w-50 input-border form-control" id="newName">
<!-- </div> -->
</div>
<div class="d-flex justify-content-between mb-1 gap-1rem">
<div class="input-heading w-50 h5" style="line-height: 2;">
...
<!-- <div class="col-sm-7 tab_idone"> -->
<select id="active" class="chosen-select form-select w-50">
...
<div class="modal-footer ">
<div class="pull-right">
<a class="btn bottomsavebtn btn-primary input-save me-5 close" id="editvaluesubmit">Save</a>
<a href="#" data-dismiss="modal" class="btn addgrpcancel btn-danger input-save" id="canceledititem">Cancel</a>
</div>
</div>
</div>
</div>
...
<div class="modal-content">
<div class="modal-header jc-cntr">
<h5 class="modal-title text-center body-heading" id="exampleModalLabel">Delete Picklist Item</h5>
</div>
<div class="modal-body">
<form class="" action="" name="" role="form">
<div class="d-flex justify-content-between mb-1 gap-1rem">
<div class="input-heading w-50 h5" style="line-height: 2;">
<label for="deleteItem">Item Value</label>
</div>
<!-- <div class="col-sm-7 tab_idone"> -->
<select id="sam_delete" class="chosen-select form-select w-50" data-placeholder="Select Role Name"></select>
<!-- </div> -->
</div>
</form>
</div>
<div class="modal-footer">
<div class="pull-right">
<button type="button" class="btn bottomsavebtn btn-primary input-save me-5 close" id="deletevaluesubmit">Delete</button>
<a href="#" data-dismiss="modal" class="btn addgrpcancel btn-danger input-save">Discard</a>
</div>
</div>
</div>
</div>
...
$('#sam_delete').removeAttr('style');
$('#sam_delete_chosen').css("display", "none");
...
$('#addafter').html(data);
$('#sam_delete').removeAttr('style');
$('#sam').removeAttr('style');
$('#active').removeAttr('style');
$('#sam_chosen').css("display", "none");
$('#active_chosen').css("display", "none");
$('#sam_delete_chosen').css("display", "none");
