        ...
        if (is_array($blocks)) {
            ...
            foreach ($blocks as $block) {
                if (!$block instanceof Blocks) {
                    throw new \Exception("Invalid block provided. Must be an instance of Block.");
                }
            }

            // Assign the blocks array to the private _blocks property
            $this->_blocks = $blocks;
        } else {
            throw new \Exception("Blocks must be an array.");
        }
    }
