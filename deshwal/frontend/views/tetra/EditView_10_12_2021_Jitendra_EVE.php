				...
				<div data-simplebar>
					<?php if($Block->blocklable){ ?>
						...
						<!--<div class="simple-table d-flex justify-content-between">
							...
							<div class="simple-table__container">
								<div class="d-flex justify-content-between">
									<div class="input-heading simple-table__container__heading">AEL Manpower</div>
									<input type="text" class="input-border simple-table__container__input" value="12345">
								</div>
							</div>
							<div class="simple-table__container">
								<div class="d-flex justify-content-between">
													...
													<div class="modal-content">
														<div class="body-outline h-auto">
															<div class="modal-body position-relative" data-que="<?php echo $reason_counter;?>">
																<div class="d-flex justify-content-between">
																	<div class="input-heading">Stopage Reason</div>
																	<div class="input-heading">Hours</div>
																</div>
																<?php 
																	...
																	<?php } 
																?>
																<div class="add-btn btn-primary d-flex jc-cntr align-items-center position-absolute bottom-0 end-0 add-rows-to-pop">
																	<svg width="16" height="16" viewBox="0 0 16 16">
																		<path d="M6 16H10V10H16V6H10V0H6V6H0V10H6V16Z" fill="#ffffff"/>
																	</svg>                        
																</div>
