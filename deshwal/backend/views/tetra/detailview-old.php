...
<div class="pipeline-container">
    ...
    <div class="pipeline-stages">
        <div class="stage stage-new active" data-stage="new">New</div>
        <div class="stage stage-not-contacted" data-stage="not-contacted">Not Contacted</div>
        <div class="stage stage-changes-required" data-stage="changes-required">Changes Required</div>
        <div class="stage stage-approval-pending" data-stage="approval-pending">Approval Pending</div>
        <div class="stage stage-qualified" data-stage="qualified">Qualified</div>
        <div class="stage stage-converted" data-stage="converted">Converted</div>
...
$this->registerJs("
    ...
    $('#add-lead-btn').on('click', function () {
         $.get('edit?Record={$Record}', function(data) {
