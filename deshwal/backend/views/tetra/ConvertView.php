...
$lead_org = $Record['lead_org'];
if ($lead_org == 2) {//if devit then create opportunity
    $showopportunity = 1;
} else {
    $showopportunity = 0;
}
...
<link href="<?= $baseUrl . 'thememain/css/convertview.css' ?>" rel="stylesheet">
...
<div class="modal-body" id="modalBody">
    <div class="create-form">
        ...
        <div class="mainrow">
            ...
            <input type="hidden" value="<?php echo $Record['departments'] ?>" id="departments" name="departments" />
            <input type="hidden" value="<?php echo $Record['designation'] ?>" id="designation" name="designation" />
            <input type="hidden" value="<?php echo $Record['industry'] ?>" id="industry" name="industry" />
            <!-- for opportuity -->
            <input type="hidden" value="<?php echo $Record['email']; ?>" name="opportunity[requester_email_customer_email]">
            <input type="hidden" value="<?php echo $Record['vendor']; ?>" name="opportunity[vendor_account_name]">
            <input type="hidden" value="<?php echo $Record['phone']; ?>" name="opportunity[requester_mobile]">
            <input type="hidden" value="<?php echo $Record['lead_source']; ?>" name="opportunity[lead_source]">
            <input type="hidden" value="1" name="opportunity[opportunity_stage]">
            <!-- for contacts -->
            <input type="hidden" value="<?php echo $mobile; ?>" name="contacts[mobile]">
            <input type="hidden" value="<?php echo $Record['email']; ?>" name="contacts[email]">
            ...
            <input type="hidden" value="<?php echo $Record['departments']; ?>" name="departments">
                ...
                <div class="row">
                            ...
                            <div>
                                <div class="vendor-input-wrapper">
                                    ...
                                    <svg class="icon-left" fill="#2F80ED" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <?php //onclick="removeTextValue(vendor_name1,vendor);" ?>
                                        id="removeTextValue" 
                                        data-fieldname1="vendor_name1"
                                    ...
                                    <svg class="icon-right search-icon convertview" width="15" height="15" viewBox="0 0 24 25"
                                        ...
                                        data-display="acc_name"
                                        data-module="vendoraccount"
                                        data-fieldid="13"
                                        data-val6=""
                                        data-val7=""
                                        data-val8=""
                                        data-sourcemodule=""
                                        data-sourceid=""
                                        <?php //onclick="showCustomer1('vendor_name1','vendor_name','acc_name','vendoraccount',13)"?>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <!-- HTML Form without Model -->
                            <div class="form-group">
                                <label for="deal_name">Account Category</label>
                                <!-- <select id="account_category"
                                    class="multySelect form-control V~M error"
                                    name="vendor_account[account_category][]" multiple="" size="4">
                                    <option value="" >Select Account Category
                                    </option>
                                    <option value="1">Vendor</option>
                                    <option value="2">Client</option>
                                    <option value="3">Partner</option>
                                </select> -->
                                <!-- Change from multi select to the single select (vishwas)  -->
                                <select id="account_category"
                                    class="form-control V~M error"
                                    name="vendor_account[account_category]"
                                    size="4">
                        ...
                        <div class="input-group mb-2">
                            <div class="input-group-prepend">
                                <div class="input-group-text" style="background: none;">
                                    <select name="contacts[salutation]" style="background: none;
              border: none;
              padding: 2px;">
                                        <option class="opt-none" value="">None</option>

                                        <?php
                                        $sql = "select * from salutationtype where is_active =1 order by seq_no";
                                        $res = Yii::$app->db->createCommand($sql)->queryAll();
                                        foreach ($res as $val) {
                                            $sel = '';
                                            if ($val['salutationid'] == $Record['salutation'])
                                                $sel = "selected";

                                            ?>
                                            <option class="opt-none" <?= $sel; ?> value="<?= $val['salutationid'] ?>">
                                                <?= $val['salutationtype'] ?></option>
                                            <?php
                                        } ?>
                            ...
                            </div><input type="text" id="first_name" class="form-control  AN~M"
                                name="contacts[first_name]" maxlength="100" data-pristine-required="true"
                    ...
                    <div class="form-group chooseontact">
                        ...
                        <div>
                            ...
                            <div class="vendor-input-wrapper">
                                ...
                                <svg class="icon-left" fill="#2F80ED" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" width="15" height="15" role="button" tabindex="0"
                                    <?php //onclick="removeTextValue(contact_name1,contact_name);" ?>
                                    id="removeTextValue" 
                                    data-fieldname1="contact_name1"
                                ...
                                <svg class="icon-right search-icon convertview" width="15" height="15" viewBox="0 0 24 25"
                                    ...
                                    <?php //onclick="showCustomer1('contact_name1','contact_name','first_name','contacts',40)" ?>
                                    
                                    id="showCustomer1"
                                    data-fieldname1="contact_name1"
                                    data-fieldname="contact_name"
                                    data-display="first_name"
                                    ...
                                    data-val8=""
                                    data-sourcemodule=""
                                    data-sourceid="" aria-label="Search vendor">
                                    <path
                                        d="M21 21.5L16.514 17.006L21 21.5ZM19 11C19 13.2543 18.1045 15.4163 16.5104 17.0104C14.9163 18.6045 12.7543 19.5 10.5 19.5C8.24566 19.5 6.08365 18.6045 4.48959 17.0104C2.89553 15.4163 2 13.2543 2 11C2 8.74566 2.89553 6.58365 4.48959 4.98959C6.08365 3.39553 8.24566 2.5 10.5 2.5C12.7543 2.5 14.9163 3.39553 16.5104 4.98959C18.1045 6.58365 19 8.74566 19 11V11Z"
                                        stroke="#2F80ED" stroke-width="2" stroke-linecap="round"></path>
                                </svg>
...
<div class="modal-footer">
    ...
    <?= Html::Button("Cancel", [
        "class" => "btn mod-close btn-secondary btn-close-convertlead",
        "name" => "btncancel",
    ]) ?>
...
<!-- Link to your validator.js file -->
 <!-- it is added in convertlead.js file -->
