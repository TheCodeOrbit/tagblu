...
/**
 * This is the model class for table "inspection_full_product_detail_desktop".
 *
 ...
 */
class InspectionFullProductDetailDesktop extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'inspection_full_product_detail_desktop';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['inspection_id', 'prod_category', 'make', 'model', 'generation', 'ram', 'storage_capacity', 'storage_type', 'physical_dent', 'critical'], 'integer'],
            [['serial_number', 'image_open', 'image_front', 'image_back', 'image_motherboard', 'remarks'], 'string', 'max' => 200],
            [[ 'quantity',], 'number'],
        ];
    }
    ...
    public function saveInspectionFullProductDetailDesktop($entityId)
    {
         if (empty($_POST['inspection_full_product_detail_desktop']) || !is_array($_POST['inspection_full_product_detail_desktop'])) {
            return false;
        }
        else{
             //delete old record from child table
            
             $sql = "Delete from inspection_full_product_detail_desktop where inspection_id = :inspection_id";
        ...
        $uploadedFiles = $_FILES['inspection_full_product_detail_desktop']??null;
        $grn_items=$_POST['inspection_full_product_detail_desktop'];
		if(count($grn_items)>0)
		{
			...
			$product_detail_obj=new InspectionFullProductDetailDesktop();	
