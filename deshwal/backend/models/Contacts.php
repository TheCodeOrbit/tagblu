...
class Contacts extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            // 'vendor_account_name', //remove by ptpatel on date 24-01-2026
            [['ownerid', 'creatorid', 'modifiedby', 'createdtime', 'modifiedtime', 'level_management', 'department', 'role', 'role_0', 'status', 'related_to', 'related_to_id', 'contact_role', 'designation', 'relationship', 'salutation', 'first_name', 'last_name', 'vendor_location', 'mobile', 'email', 'landline', 'anniversary_date', 'birth_date', 'strength', 'contact_no', 'home_mobile', 'home_email', 'active_contact', 'reports_to', 'remark', 'weakness', 'social', 'facebook', 'linkedIn', 'twitter', 'instagram', 'mailing_street', 'mailing_city', 'mailing_state', 'mailing_zip', 'mailing_country', 'other_street', 'other_city', 'other_state', 'other_zip', 'other_country', 'username', 'password', 'auth_key', 'seq_no', 'industry', 'hierarchy_level', 'description', 'do_not_call', 'email_opt_out', 'gender', 'middle_name', 'nick_name', 'official_mobile_number', 'personal_mobile_number', 'alternative_phone', 'password_reset_token', 'contact_validation'], 'default', 'value' => null],
            [['is_temp'], 'default', 'value' => 0],
            [['ownerid', 'creatorid', 'modifiedby', 'is_admin', 'related_to', 'related_to_id', 'salutation', 'vendor_account_name', 'landline', 'home_mobile', 'active_contact', 'deleted', 'is_temp', 'seq_no', 'official_mobile_number', 'personal_mobile_number', 'contact_validation'], 'integer'],
