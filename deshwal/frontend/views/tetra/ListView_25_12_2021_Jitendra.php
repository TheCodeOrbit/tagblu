...
<div id="ListDrill" class="show">
	<div class="body-menu d-flex justify-content-between">
		...
		<?php if(in_array('5',$val) or $operation['opt'] =='1') {
			if($ModuleName=="water_management" || $ModuleName=="ehs" || $ModuleName=="debtors"  || $ModuleName=="manpower" || $ModuleName=="equipment" || $ModuleName=="contractormaster" || $ModuleName=="location" || $ModuleName=="material" || $ModuleName=="revenue_data"){}
			else{ ?>
						...
						<?php if($modulepermission['shareid'] == '0') {?>
							...
							<tr>
								...
								<td class="text-three-dots-container hover-element-container">
									<div class="hover-element-container-label">this is a comment which is quite small-5</div>
									<div class="text-three-dots">
										this is a comment which is quite small-5
									</div>
								</td>
							</tr>
